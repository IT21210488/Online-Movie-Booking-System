...
<body>
	...
	<?php 
		...
		$C_ID = '4808AAE1-31F7-4C42-BB58-1147815D3B27';

		$mysqli= new mysqli('localhost', 'root', '', 'MBS') or die(mysqli_error($mysqli));
		$result = $mysqli->query("SELECT B_ID, MovieName, TheatreName, Time, SeatNo FROM booking b, movie m, customer c, theatre t where b.C_ID = 13 AND b.C_ID = c.C_ID AND b.M_ID = m.M_ID AND b.T_ID = t.T_ID;");
		//pre_r($result);
